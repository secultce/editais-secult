                    ...
                    <div class="col-lg-3  wow zoomIn" data-wow-delay="0.3s" style="min-height: 350px;">
                        <div class="blog-item bg-light rounded overflow-hidden">
                            <div class="blog-img position-relative overflow-hidden">
                                <div class="nova">
                                    <img id="dimensao" src="img/imagensEditais/@arquivo">
                                </div>
                                <div
                    ...
                    <div class="col-lg-4">
                        <div class="row g-4">
                            ...
                            <div class="col-12 wow zoomIn" data-wow-delay="0.6s">
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-3"></i>Nº:
                                </p>
                                ...
                                <p class="mb-0"><i
                                        class="fa fa-arrow-right text-primary me-3"></i>Telefone:
                                </p>
                                <p class="mb-0"><i
                                        class="fa fa-arrow-right text-primary me-3"></i>Categoria:
                                </p>
                                <p class="mb-0"><i class="fa fa-arrow-right text-primary me-3"></i>status:
                                </p>
                                <br>
                            </div>
                        </div>
                            ...
                            <div class="col-12 wow zoomIn" data-wow-delay="0.1s">
                                ...
                                <p class="mb-0">
                                    ...
                                    <li id="0" class="widget-list-item"><span><a
                                                href="http://localhost/EditaisMVC/links/listaDeLinks/@id">Lista
